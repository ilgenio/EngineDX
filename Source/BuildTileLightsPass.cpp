                                 ...
                                 D3D12_GPU_DESCRIPTOR_HANDLE depthSRV)
{
    ...
    D3D12_GPU_VIRTUAL_ADDRESS constantsAddress = dynamicBuffer->alloc(&constants);

    D3D12_GPU_VIRTUAL_ADDRESS pointSphereAddress = dynamicBuffer->alloc(pointSphereData.data(), pointSphereData.size());
    D3D12_GPU_VIRTUAL_ADDRESS spotSphereAddress = dynamicBuffer->alloc(spotSphereData.data(), spotSphereData.size());
