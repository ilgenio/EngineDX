...
DecalCubeMesh::DecalCubeMesh()
{
    ...
    vertexBuffer    = app->getResources()->createDefaultBuffer(&vertices[0], sizeof(vertices), "DecalCubeMesh");
...
void DecalCubeMesh::draw(ID3D12GraphicsCommandList* commandList) const
{
