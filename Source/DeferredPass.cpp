...
void DeferredPass::render(ID3D12GraphicsCommandList* commandList, const RenderData& renderData)
{
    ...
    commandList->SetGraphicsRootDescriptorTable(SLOT_SSAO_TABLE, renderData.ssaoResult);
